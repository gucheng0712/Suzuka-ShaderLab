Shader "Dissolve Effects/DirectionalDissolve" 
{
    ...
    SubShader {
        ...
        // when Unity batches a bunch of the same meshes together,
        // the object space coordinates (which we kinda use for the dissolving) all get unified, 
        //  and they stop referring to each instance’s actual object coordinates.
        ...
        // Using the Lambert lighting model, can make the shadow of the object will also get clipped along with the dissolving.
        ...
        void vert (inout appdata_full v, out Input o) {
            UNITY_INITIALIZE_OUTPUT(Input,o); // Initialize the “Input” object
            o.worldPosAdj =  mul (unity_ObjectToWorld, v.vertex.xyz); // Convert vertex from object space to world  
        }
